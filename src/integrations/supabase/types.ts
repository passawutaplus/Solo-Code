...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ad_application_status: "pending" | "approved" | "rejected" | "pending_payment" | "paid";
      ad_event_type: "impression" | "click" | "interest";
      ad_package: "basic" | "standard" | "premium";
      ad_status: "draft" | "pending" | "approved" | "active" | "paused" | "rejected" | "expired";
      app_role: "admin" | "user";
      collab_status: "pending" | "interested" | "passed" | "archived" | "accepted" | "declined";
      hire_budget: "1k-5k" | "5k-20k" | "20k-50k" | "50k+";
      hire_status: "ใหม่" | "ที่ต้องตอบ" | "ติดต่อแล้ว" | "ปิดแล้ว" | "ตอบรับ" | "ปฏิเสธ";
      inhouse_member_role: "owner" | "admin" | "member" | "viewer";
      inhouse_member_status: "invited" | "active" | "removed";
      job_application_status: "pending" | "shortlisted" | "rejected" | "accepted";

...
export function SiteFooter({ variant = "minimal", className = "" }: { variant?: Variant; className?: string }) {
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              />
              <span className="font-semibold text-sm">So<span className="text-primary">1</span>o Freelancer</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-muted-foreground">
              <li><LineContactChip /></li>
              <li>
                <a href="mailto:hello@solofreelancer.com" className="hover:text-primary transition-colors inline-flex items-center gap-1.5">

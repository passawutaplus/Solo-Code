...
export function ColorLabInline({ hex, onHexChange, onApply, applyLabel = "+ เพิ่มเข้าบรีฟ", showPreview = true }: Props) {
    ...
    <div>
      {showPreview && (
        ...
        >
          <div className="text-center space-y-1">
            ...
            <div className="text-[10px] sm:text-xs font-mono opacity-80">{hex} · {breakdown.rgb.css}</div>
          </div>
      ...
      <div className="p-1 pt-4 space-y-4">
          ...
          <TabsContent value="picker" className="mt-4 space-y-4">
            <div className="grid sm:grid-cols-[260px_1fr] gap-4 items-start">
              <div className="space-y-3">
                <ColorChartPicker value={hex} onChange={commitHex} className="w-full max-w-[260px] mx-auto sm:mx-0" />
        ...
        <p className="text-[10px] text-muted-foreground italic">
          * ค่า CMYK / Pantone เป็นการคำนวณเบื้องต้นจากหน้าจอ โปรดตรวจสอบกับโรงพิมพ์อีกครั้งก่อนสั่งผลิต
        </p>
      </div>

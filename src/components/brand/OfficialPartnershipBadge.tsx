    ...
    <div className={cn('flex flex-col items-center gap-2', className)}>
      <div className="flex items-center justify-center gap-2.5">
        <img
          ...
          className={cn('rounded-lg object-cover ring-1 ring-border', compact ? 'h-6 w-6' : 'h-8 w-8')}
        />
        <span className="text-muted-foreground text-sm font-medium" aria-hidden>×</span>
        <span
          className={cn(

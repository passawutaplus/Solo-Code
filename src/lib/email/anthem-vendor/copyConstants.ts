...
export const DEMO_BANNER_SHORT = "โหมด UX Research — บัญชี demo บันทึกถาวร";

export const DEMO_LOGIN_HINT = "ใช้บัญชี demo ด้านล่าง — อย่าสมัครใหม่";

export const DEMO_SIGNUP_BLOCKED = "ปิดการสมัครในโหมดทดสอบ — ใช้บัญชี demo";
...
export const EMAIL_FOOTER_NOTIFICATION = "ปิดการแจ้งเตือนได้ที่ Pixel100 → Settings → การแจ้งเตือน";

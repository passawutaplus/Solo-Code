...
import { LINE_ID, LINE_URL } from "@/components/LineContactButton";
...
/** So1o logo × LINE — official partnership trust strip */
      ...
      <Column align="center">
        ...
        >
          <Row style={{ width: "auto", margin: "0 auto 10px" }}>
            ...
            <Column
              style={{ width: "20px", verticalAlign: "middle", textAlign: "center" as const }}
            >
              <Text style={{ margin: 0, fontSize: "14px", color: brand.mute, fontWeight: 600 }}>
                ×
              </Text>
            </Column>
            <Column style={{ width: "32px", verticalAlign: "middle" }}>
          ...
          <Text
            style={{ margin: "4px 0 0", fontSize: "11px", color: brand.mute, lineHeight: "1.5" }}
          >
            แจ้งเตือนผ่าน LINE ได้ที่{" "}
            <Link href={LINE_URL} style={{ ...link, fontSize: "11px" }}>
              {LINE_ID}
            </Link>
          </Text>
        </div>

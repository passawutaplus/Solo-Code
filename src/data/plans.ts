...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "LINE แจ้งเตือนได้ · โชว์เคส an1hem เต็มรูปแบบ",
    ],
    features: [
      "ปลดล็อก So1o My Desk + an1hem บัญชีเดียว",
      "Job Tracker ไม่จำกัด",
  ...
  },
  {
    ...
    details: [
      ...
      "ใบเสนอราคาทีม + รวมสมาชิก an1hem nest ออกใบเดียวให้ลูกค้า",
      "แบบร่าง an1hem 100 ชิ้น · Co-working workspace พร้อมใช้",
    ],
    features: [
      "ทุกอย่างใน Pro (white-label ส่วนตัว)",
      "AI 2,000 เครดิต/รอบบิล",

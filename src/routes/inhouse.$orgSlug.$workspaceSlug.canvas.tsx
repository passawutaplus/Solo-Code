...
export const Route = createFileRoute("/inhouse/$orgSlug/$workspaceSlug/canvas")({
  errorComponent: ({ error }) => <RouteError error={error} />,
  component: () => (
    <RequireAuth>
      <InhouseWorkspaceRoute view="canvas" />
    </RequireAuth>
  ),
});

function InhouseWorkspaceRoute({ view }: { view: "canvas" }) {

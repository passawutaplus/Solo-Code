...
export const Route = createFileRoute("/inhouse/$orgSlug/$workspaceSlug/monitor")({
  errorComponent: ({ error }) => <RouteError error={error} />,
  component: () => (
    <RequireAuth>
      <InhouseWorkspaceRoute view="monitor" />
    </RequireAuth>
  ),
});

function InhouseWorkspaceRoute({ view }: { view: "monitor" }) {

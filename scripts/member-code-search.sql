-- Member code search: S + last 7 hex of user_id (matches Solo-Code formatMemberCode)
...
COMMENT ON FUNCTION public.admin_search_users(text, int) IS
  'Admin user search by name, email, username, user_id prefix, or member code (S + 7 hex).';

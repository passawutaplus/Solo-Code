...
const sql = `-- Credit AI daily layer: 5 credits/day (non-stacking) on top of pack/purchased pool.
...
const out = join(root, "supabase/migrations/20260621140000_ai_daily_credits_layer.sql");
